...
public class TelaParImpar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Par Ímpar");

        jPanel1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        spinnerInput.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
        spinnerInput.setModel(new javax.swing.SpinnerNumberModel());
        ...
        lblResultado.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int input = (int) spinnerInput.getValue();

        if (input % 2 == 0) {
            lblResultado.setText("O número " + input + " é par!");
        } else {
            lblResultado.setText("O número " + input + " é ímpar!");
        }
